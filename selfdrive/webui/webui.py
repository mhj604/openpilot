...
PARAM_HELP: Dict[str, Dict[str, str]] = {
  ...
  "TorqueKp": {"description": "토크 횡제어의 비례 게인입니다. 무SCC 그랜저에서는 속도별 Kp 곡선 전체의 기준값입니다.", "unit": "gain", "hint": "raw × 0.1 ÷ max lateral accel"},
  "TorqueKi": {"description": "토크 횡제어의 적분 게인입니다.", "unit": "gain", "hint": "raw × 0.1 ÷ max lateral accel"},
  "TorqueKf": {"description": "목표 횡가속도를 조향 토크로 변환하는 비율입니다. 기존 제어기에서는 피드포워드 게인으로 사용됩니다.", "unit": "gain", "hint": "raw × 0.1 ÷ max lateral accel"},
  ...
  "TorqueUseAngle": {"description": "토크 제어의 실제 곡률 계산에 조향각 센서를 사용합니다. 무SCC 그랜저의 최신 제어기는 항상 조향각을 사용합니다."},
...
PARAM_EFFECT: Dict[str, str] = {
  ...
  "TorqueKp": "높이면 횡가속 오차에 더 강하게 반응합니다. 무SCC 그랜저에서는 저속일수록 자동으로 커지는 Kp 곡선 전체를 조절합니다. 너무 높으면 진동, 너무 낮으면 경로 추종이 느려집니다.",
  "TorqueKi": "높이면 남아 있는 횡가속 오차를 더 빨리 누적 보정합니다. 너무 높으면 오버슈트와 흔들림이 생길 수 있습니다.",
  "TorqueKf": "무SCC 그랜저에서는 제어기가 계산한 횡가속 출력을 실제 조향 토크로 변환하는 비율입니다. 높이면 피드포워드와 오차 보정이 모두 강해지고, 낮추면 전체 조향 출력이 약해집니다.",
